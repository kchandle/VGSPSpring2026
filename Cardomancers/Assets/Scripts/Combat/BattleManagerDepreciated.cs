...
using TMPro;
using static BattleManagerDepreciated;

public class BattleManagerDepreciated : MonoBehaviour
{
    public static BattleManagerDepreciated instance; // singleton instance
